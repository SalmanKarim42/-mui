...
interface ChangeYearPayload<TDate> {
    newMonth: TDate;
}
...
} | ReducerAction<"changeMonth", ChangeMonthPayload<TDate>> |ReducerAction<"changeYear", ChangeYearPayload<TDate>>| ReducerAction<"changeFocusedDay", {
    focusedDay: TDate;
}>) => CalendarState<TDate>;
...
export declare function useCalendarState<TDate>({ date, defaultCalendarMonth, disableFuture, disablePast, disableSwitchToMonthOnDayFocus, maxDate, minDate, onMonthChange, reduceAnimations, shouldDisableDate, }: CalendarStateInput<TDate>): {
    ...
    handleChangeYear: (payload: ChangeYearPayload<TDate>) => void;
};
export {};
